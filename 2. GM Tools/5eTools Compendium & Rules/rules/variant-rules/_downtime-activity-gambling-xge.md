...
The character makes three checks: Wisdom ([Insight](_skills.md#Insight)), Charisma ([Deception](_skills.md#Deception)), and Charisma ([Intimidation](_skills.md#Intimidation)). If the character has proficiency with an appropriate [gaming set](gaming-set.md), that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Gambling Results table to see how the character did.
