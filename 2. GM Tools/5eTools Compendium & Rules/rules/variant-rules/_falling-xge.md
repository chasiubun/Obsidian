...
A flying creature in flight falls if it is knocked [prone](_conditions.md#prone), if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [fly](compendium/spells/fly.md) spell.
