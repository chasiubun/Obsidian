...
- [Downtime Activity: Buying a Magic Item](_downtime-activity-buying-a-magic-item-xge.md)  
- [Downtime Activity: Carousing](_downtime-activity-carousing-xge.md)  
- [Downtime Activity: Crafting an Item](_downtime-activity-crafting-an-item-xge.md)  
- [Downtime Activity: Crime](_downtime-activity-crime-xge.md)  
- [Downtime Activity: Gambling](_downtime-activity-gambling-xge.md)  
- [Downtime Activity: Pit Fighting](_downtime-activity-pit-fighting-xge.md)  
- [Downtime Activity: Relaxation](_downtime-activity-relaxation-xge.md)  
- [Downtime Activity: Religious Service](_downtime-activity-religious-service-xge.md)  
- [Downtime Activity: Research](_downtime-activity-research-xge.md)  
- [Downtime Activity: Scribing a Spell Scroll](_downtime-activity-scribing-a-spell-scroll-xge.md)  
- [Downtime Activity: Selling a Magic Item](_downtime-activity-selling-a-magic-item-xge.md)  
- [Downtime Activity: Training](_downtime-activity-training-xge.md)  
- [Downtime Activity: Work](_downtime-activity-work-xge.md)