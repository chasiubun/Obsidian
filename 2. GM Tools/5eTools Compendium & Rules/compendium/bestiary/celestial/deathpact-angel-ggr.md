...
***Exploitation of the Debtors.*** As a bonus action, the angel targets a creature [charmed](/compendium/rules/conditions.md#charmed) by it that it can see within 30 feet of it. The angel deals 11 (`2d10`) necrotic damage to the target, and the angel gains temporary hit points equal to the damage dealt.
...
***Chains of Obligation.*** The angel targets one creature [charmed](/compendium/rules/conditions.md#charmed) by it that it can see within 90 feet of it. The target must succeed on a DC 19 Charisma saving throw or become [paralyzed](/compendium/rules/conditions.md#paralyzed) for 1 minute or until it takes any damage.
```
^statblock