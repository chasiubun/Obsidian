...
```ad-statblock
title: Gloomstalker
![](/compendium/bestiary/monstrosity/token/gloomstalker.png#token)
...
***Snatch.*** *Melee Weapon Attack:* +9 to hit, reach 5 ft., one Medium or smaller creature. *Hit:* 13 (`2d6 + 6`) slashing damage plus 7 (`2d6`) necrotic damage, and the target is [grappled](/compendium/rules/conditions.md#grappled) (escape DC 17). While [grappled](/compendium/rules/conditions.md#grappled) in this way, the target is [restrained](/compendium/rules/conditions.md#restrained).

***Shriek (Recharge 6).*** The gloomstalker emits a terrible shriek. Each enemy within 60 feet of the gloomstalker that can hear it must succeed on a DC 13 Constitution saving throw or be [paralyzed](/compendium/rules/conditions.md#paralyzed) until the end of the enemy's next turn.
```
^statblock