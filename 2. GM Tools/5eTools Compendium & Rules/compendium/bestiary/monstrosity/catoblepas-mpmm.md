...
***Tail.*** *Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 21 (`5d6 + 4`) bludgeoning damage, and the target must succeed on a DC 16 Constitution saving throw or be [stunned](/compendium/rules/conditions.md#stunned) until the start of the catoblepas's next turn.
