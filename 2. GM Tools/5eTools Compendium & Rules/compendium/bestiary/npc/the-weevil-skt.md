...
```ad-statblock
title: The Weevil
![](/compendium/bestiary/npc/token/the-weevil.png#token)
...
***Parry.*** The Weevil adds 2 to its AC against one melee attack that would hit it. To do so, the Weevil must see the attacker and be wielding a melee weapon.
```
^statblock