...
```ad-statblock
title: Grazilaxx
![](/compendium/bestiary/npc/token/grazilaxx.png#token)
...
***Innate Spellcasting.*** Grazilaxx can innately cast can cast the [teleport](/compendium/spells/teleport.md) spell once per day, but the intended destination must be within 30 feet of another society member. This teleport effect can be disrupted (see "Faerzress"), which is how society members sometimes end up in far corners of the Underdark, separated from their fellows.
