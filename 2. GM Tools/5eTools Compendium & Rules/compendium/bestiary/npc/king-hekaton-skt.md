...
```ad-statblock
title: King Hekaton
![](/compendium/bestiary/npc/token/king-hekaton.png#token)
...
***Thunderous Stomp (Recharge 6).*** Hekaton stomps the ground, triggering a thunderclap. All other creatures within 15 feet of him must succeed on a DC 17 Constitution saving throw or take 33 (`6d10`) thunder damage and be [deafened](/compendium/rules/conditions.md#deafened) until the start of Hekaton's next turn. On a successful save, a creature takes half as much damage and isn't [deafened](/compendium/rules/conditions.md#deafened). The thunderclap can be heard out to a range of 1,200 feet.
```
^statblock