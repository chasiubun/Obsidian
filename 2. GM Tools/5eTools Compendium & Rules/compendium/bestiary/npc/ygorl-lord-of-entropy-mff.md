...
***Entropic Touch.*** *Melee Weapon Attack:* +14 to hit, reach 5 ft., one target. *Hit:* 16 (`2d8 + 7`) necrotic damage, and the target must succeed on a DC 22 Constitution saving throw or gain one level of [exhaustion](/compendium/rules/conditions.md#exhaustion).
