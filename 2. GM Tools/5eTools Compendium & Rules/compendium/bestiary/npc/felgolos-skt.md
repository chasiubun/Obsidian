...
---
# Felgolos
*Source: Storm King's Thunder p. 192, Derived from *  

```ad-statblock
title: Felgolos
![](/compendium/bestiary/npc/token/felgolos.png#token)
...
***Detect.*** Felgolos makes a Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check.

***Tail Attack.*** Felgolos makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Felgolos beats its wings. Each creature within 10 feet of Felgolos must succeed on a DC 20 Dexterity saving throw or take 14 (`2d6 + 7`) bludgeoning damage and be knocked [prone](/compendium/rules/conditions.md#prone). Felgolos can then fly up to half its flying speed.
```
^statblock