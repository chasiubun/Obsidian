...
---
# Ougalop
*Source: Out of the Abyss p. 142, Derived from *  

```ad-statblock
title: Ougalop
![](/compendium/bestiary/npc/token/ougalop.png#token)
...
***Otherworldly Perception.*** Ougalop can sense the presence of any creature within 30 feet of it that is [invisible](/compendium/rules/conditions.md#invisible) or on the Ethereal Plane. It can pinpoint such a creature that is moving.

***Slippery.*** Ougalop has advantage on ability checks and saving throws made to escape a grapple.

***Sunlight Sensitivity.*** While in sunlight, Ougalop has disadvantage on attack rolls, as well as on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks that rely on sight.
