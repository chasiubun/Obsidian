...
---
# Zilchyn Q'Leptin
*Source: Out of the Abyss p. 137, Derived from *  

```ad-statblock
title: Zilchyn Q'Leptin
![](/compendium/bestiary/npc/token/zilchyn-qleptin.png#token)
...
***Fey Ancestry.*** Zilchyn has advantage on saving throws against being [charmed](/compendium/rules/conditions.md#charmed), and magic can't put Zilchyn to sleep.

***Sunlight Sensitivity.*** While in sunlight, Zilchyn has disadvantage on attack rolls, as well as on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks that rely on sight.
