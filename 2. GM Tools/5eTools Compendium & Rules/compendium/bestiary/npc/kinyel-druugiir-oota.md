...
![](/compendium/bestiary/npc/token/kinyel-druugiir.png#token)
...
***Sneak Attack (1/Turn).*** Kinyel deals an extra 14 (`4d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Kinyel that isn't [incapacitated](/compendium/rules/conditions.md#incapacitated) and Kinyel doesn't have disadvantage on the attack roll.
