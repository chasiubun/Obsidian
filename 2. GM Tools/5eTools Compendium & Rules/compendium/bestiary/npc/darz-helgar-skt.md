...
```ad-statblock
title: Darz Helgar
![](/compendium/bestiary/npc/token/darz-helgar.png#token)
...
***Sneak Attack (1/Turn).*** Darz deals an extra 7 (`2d6`) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Darz that isn't [incapacitated](/compendium/rules/conditions.md#incapacitated) and Darz doesn't have disadvantage on the attack roll.
