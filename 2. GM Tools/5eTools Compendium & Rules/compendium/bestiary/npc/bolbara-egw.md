...
```ad-statblock
title: Bol'bara
![](/compendium/bestiary/npc/token/bolbara.png#token)
*Small humanoid (goblinoid), Chaotic Good (chaotic evil when fully possessed)*

- **Armor Class** 13  ([leather armor](/compendium/items/leather-armor.md); 15 with [mage armor](/compendium/spells/mage-armor.md))
- **Hit Points** 40 (`9d6 + 9`)
- **Speed** 30 ft.
...
**At will**: [eldritch blast](/compendium/spells/eldritch-blast.md), [false life](/compendium/spells/false-life.md), [mage armor](/compendium/spells/mage-armor.md), [mage hand](/compendium/spells/mage-hand.md)

**1/day each**: [charm person](/compendium/spells/charm-person.md), [hex](/compendium/spells/hex.md), [hold person](/compendium/spells/hold-person.md), [invisibility](/compendium/spells/invisibility.md)
...
***Zone of Calamity (Costs 2 Actions).*** A 15-foot-radius sphere of magical confusion extends from a point Bol'bara can see within 60 feet of her and spreads around corners. Each creature that starts its turn in that area is treated as if targeted by the [confusion](/compendium/spells/confusion.md) spell (save DC 12). The sphere lasts as long as Bol'bara maintains [concentration](/compendium/rules/conditions.md#concentration), up to 1 minute (as if concentrating on a spell).
```
^statblock