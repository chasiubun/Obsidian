...
```ad-statblock
title: Duke Zalto
![](/compendium/bestiary/npc/token/duke-zalto.png#token)
...
***Tackle.*** When Zalto enters any enemy's space for the first time on a turn, the enemy must succeed on a DC 19 Strength saving throw or be knocked [prone](/compendium/rules/conditions.md#prone).
