...
*Source: Explorer's Guide to Wildemount p. 158, Derived from *  

```ad-statblock
title: Karkethzerethzerus, the Sable Despoiler
![](/compendium/bestiary/npc/token/karkethzerethzerus-the-sable-despoiler.png#token)
...
***Shadow Stealth.*** While in dim light or darkness, the dragon can take the [Hide](/compendium/rules/actions.md#Hide) action as a bonus action.
...
***Wing Attack (Costs 2 Actions).*** The dragon beats its wings. Each creature within 15 feet of the dragon must succeed on a DC 25 Dexterity saving throw or take 17 (`2d6 + 10`) bludgeoning damage and be knocked [prone](/compendium/rules/conditions.md#prone). The dragon can then fly up to half its flying speed.
```
^statblock