...
---
# Old Croaker
*Source: Explorer's Guide to Wildemount p. 240, Derived from *  

```ad-statblock
title: Old Croaker
![](/compendium/bestiary/npc/token/old-croaker.png#token)
...
If Old Croaker dies, a swallowed creature is no longer [restrained](/compendium/rules/conditions.md#restrained) by it and can escape from the corpse using 5 feet of movement, exiting [prone](/compendium/rules/conditions.md#prone).
```
^statblock