...
```ad-statblock
title: Zegana
![](/compendium/bestiary/npc/token/zegana.png#token)
...
**Cantrips (at will)**: [acid splash](/compendium/spells/acid-splash.md), [druidcraft](/compendium/spells/druidcraft.md), [ray of frost](/compendium/spells/ray-of-frost.md), [shape water](/compendium/spells/shape-water-xge.md)

**1st level (4 slots)**: [color spray](/compendium/spells/color-spray.md), [expeditious retreat](/compendium/spells/expeditious-retreat.md), [fog cloud](/compendium/spells/fog-cloud.md), [shield](/compendium/spells/shield.md)

**2nd level (3 slots)**: [enlarge/reduce](/compendium/spells/enlarge-reduce.md), [gust of wind](/compendium/spells/gust-of-wind.md)

**3rd level (3 slots)**: [counterspell](/compendium/spells/counterspell.md), [fly](/compendium/spells/fly.md), [slow](/compendium/spells/slow.md)

**4th level (3 slots)**: [control water](/compendium/spells/control-water.md), [ice storm](/compendium/spells/ice-storm.md), [polymorph](/compendium/spells/polymorph.md)

**5th level (2 slots)**: [conjure elemental](/compendium/spells/conjure-elemental.md), [creation](/compendium/spells/creation.md)

**6th level (1 slots)**: [move earth](/compendium/spells/move-earth.md), [wall of ice](/compendium/spells/wall-of-ice.md)

**7th level (1 slots)**: [prismatic spray](/compendium/spells/prismatic-spray.md), [teleport](/compendium/spells/teleport.md)

**8th level (1 slots)**: [control weather](/compendium/spells/control-weather.md), [dominate monster](/compendium/spells/dominate-monster.md)
...
***Enlarge (Costs 2 Actions).*** Zegana casts [enlarge/reduce](/compendium/spells/enlarge-reduce.md) on herself, using the enlarge option, without expending a spell slot.
