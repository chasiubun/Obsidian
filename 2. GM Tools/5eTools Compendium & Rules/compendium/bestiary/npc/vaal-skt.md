...
---
# Vaal
*Source: Storm King's Thunder p. 207, Derived from *  

```ad-statblock
title: Vaal
![](/compendium/bestiary/npc/token/vaal.png#token)
...
***Keen Smell.*** Vaal has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks that rely on smell.
