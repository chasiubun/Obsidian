...
```ad-statblock
title: Turvy
![](/compendium/bestiary/npc/token/turvy.png#token)
...
***Keen Smell.*** Turvy has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks that rely on smell.
