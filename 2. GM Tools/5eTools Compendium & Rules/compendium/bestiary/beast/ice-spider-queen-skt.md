...
---
# Ice Spider Queen
*Source: Storm King's Thunder p. 128, Derived from *  

```ad-statblock
title: Ice Spider Queen
![](/compendium/bestiary/beast/token/ice-spider-queen.png#token)
...
***Icy Web (Recharge 5-6).*** *Ranged Weapon Attack:* +5 to hit, range 30/60 ft., one creature. *Hit:* The target is [restrained](/compendium/rules/conditions.md#restrained) by webbing, and takes 2 (`1d4`) cold damage at the start of each of its turns. As an action, the [restrained](/compendium/rules/conditions.md#restrained) target can make a DC 12 Strength check, bursting the webbing on a success. The webbing can also be attacked and destroyed (AC 10; hp 5; vulnerability to fire damage; immunity to poison, and psychic damage).
```
^statblock