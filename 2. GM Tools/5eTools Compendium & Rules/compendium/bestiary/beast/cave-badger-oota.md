...
---
# Cave Badger
*Source: Out of the Abyss p. 96, Derived from *  

```ad-statblock
title: Cave Badger
![](/compendium/bestiary/beast/token/cave-badger.png#token)
...
***Tunneler.*** When the badger burrows, it leaves tunnels behind.
