...
***Harpoon.*** *Ranged Weapon Attack:* +7 to hit, range 50/200 ft., one creature. *Hit:* 14 (`2d10 + 3`) piercing damage, and the target has the [grappled](/compendium/rules/conditions.md#grappled) condition (escape DC 16). While the target is [grappled](/compendium/rules/conditions.md#grappled) this way, its speed isn't reduced, but it can't move farther from the giant. The target takes 5 (`1d10`) slashing damage if it escapes from the grapple or if it tries and fails. The giant can grapple only one target at a time with its harpoon.

## Bonus Actions

***Reel In.*** The giant pulls the target [grappled](/compendium/rules/conditions.md#grappled) by its Harpoon up to 20 feet toward itself.
```
^statblock