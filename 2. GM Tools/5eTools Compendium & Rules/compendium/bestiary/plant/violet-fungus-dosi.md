...
---
# Violet Fungus
*Source: Dragons of Stormwreck Isle p. 48, Derived from , Phandelver and Below: The Shattered Obelisk*  
...
***False Appearance.*** If the violet fungus is motionless at the start of combat, it has advantage on its initiative roll. Moreover, if a creature hasn't observed the fungus move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check to discern that the violet fungus isn't ordinary fungus.
