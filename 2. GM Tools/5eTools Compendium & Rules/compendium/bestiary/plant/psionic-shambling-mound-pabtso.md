...
*Source: Phandelver and Below: The Shattered Obelisk p. 108, Derived from *  

```ad-statblock
title: Psionic Shambling Mound
![](/compendium/bestiary/plant/token/psionic-shambling-mound.png#token)
...
**1/day**: [charm person](/compendium/spells/charm-person.md) (already cast)
