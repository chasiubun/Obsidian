...
You are proficient in one of the following skills of your choice: [Arcana](/compendium/rules/skills.md#Arcana), [History](/compendium/rules/skills.md#History), [Investigation](/compendium/rules/skills.md#Investigation), [Medicine](/compendium/rules/skills.md#Medicine), [Performance](/compendium/rules/skills.md#Performance), or [Sleight of Hand](/compendium/rules/skills.md#Sleight%20of%20Hand). You are also proficient with one "tool" of your choice.
