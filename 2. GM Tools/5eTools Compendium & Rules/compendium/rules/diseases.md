...
Symptoms manifest `1d4` hours after infection and include fever and disorientation. The infected creature gains one level of [exhaustion](/compendium/rules/conditions.md#exhaustion) that can't be removed until the disease is cured.
