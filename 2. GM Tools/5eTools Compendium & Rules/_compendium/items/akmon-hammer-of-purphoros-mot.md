...
While holding the hammer, you have resistance to fire damage and are immune to [exhaustion](_conditions.md#exhaustion). Additionally, you have proficiency with [smith's tools](compendium/items/smiths-tools.md) and have advantage on all ability checks made using them.
