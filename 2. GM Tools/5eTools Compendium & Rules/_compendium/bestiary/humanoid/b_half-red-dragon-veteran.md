...
The half-dragon gains [blindsight](_senses.md#blindsight) with a radius of 10 feet and [darkvision](_senses.md#darkvision) with a radius of 60 feet.
...
Here the half-dragon template has been applied to a human [b_veteran](b_veteran.md) to create a half-red dragon veteran. [Splint armor](splint-armor.md) has been replaced with [plate](plate-armor.md).
