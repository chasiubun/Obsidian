...
The most unusual of the specialized ogres, the howdah carries a palisaded wooden fort on its back. The fort serves as a fighting platform for up to four Small people. Ogre howdahs are most often seen bearing bow- and spear-wielding [goblins](b_goblin.md) into battle, or perhaps [kobolds](b_kobold.md) or [deep gnomes](b_deep-gnome-svirfneblin.md), but they might also transport other Small folk.
