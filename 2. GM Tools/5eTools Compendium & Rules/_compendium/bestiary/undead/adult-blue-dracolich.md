...
The dracolich can't be [charmed](_conditions.md#charmed), [frightened](_conditions.md#frightened), [paralyzed](_conditions.md#paralyzed), or [poisoned](_conditions.md#poisoned). It also doesn't suffer from [exhaustion](_conditions.md#exhaustion).
