...
At 10th level, you can expend two uses of Wild Shape at the same time to transform into an [air elemental](b_air-elemental.md), an [earth elemental](b_earth-elemental.md), a [fire elemental](b_fire-elemental.md), or a [water elemental](b_water-elemental.md).
