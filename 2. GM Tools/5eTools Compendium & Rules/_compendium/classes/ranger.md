...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [b_outlander](b_outlander.md) background.
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](b_gnoll.md) and [orcs](b_orc.md)) as favored enemies.

You have advantage on Wisdom ([Survival](_skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
*1st-level ranger [optional class features](_optional-class-features-tce.md), which replaces the Favored Enemy feature and works with the Foe Slayer feature*

When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](_conditions.md#concentration) (as if you were concentrating on a spell).
...
*1st-level ranger [optional class features](_optional-class-features-tce.md), which replaces the Natural Explorer feature*
...
*2nd-level ranger [optional class features](_optional-class-features-tce.md)*
...
*3rd-level ranger [optional class features](_optional-class-features-tce.md), which replaces the Primeval Awareness feature*
...
*4th-level ranger [optional class features](_optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a fighting style you know with another fighting style available to rangers. This replacement represents a shift of focus in your martial practice.

### Extra Attack (Level 5)

Beginning at 5th level, you can attack twice, instead of once, whenever you take the [Attack](_actions.md#Attack) action on your turn.
...
Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](_skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.

### Nature's Veil (Level 10)
_Source: Tasha's Cauldron of Everything p. 56_

*10th-level ranger [optional class features](_optional-class-features-tce.md), which replaces the Hide in Plain Sight feature*

You draw on the powers of nature to hide yourself from view briefly. As a bonus action, you can magically become [invisible](_conditions.md#invisible), along with any equipment you are wearing or carrying, until the start of your next turn.
...
In addition, whenever you finish a short rest, your [exhaustion](_conditions.md#exhaustion) level, if any, is decreased by 1.
...
Starting at 14th level, you can use the [Hide](_actions.md#Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](_conditions.md#invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](_conditions.md#blinded) or [deafened](_conditions.md#deafened).
