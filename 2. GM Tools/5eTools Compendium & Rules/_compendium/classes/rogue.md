...
You can make a rogue quickly by following these suggestions. First, Dexterity should be your highest ability score. Make Intelligence your next-highest if you want to excel at Investigation or plan to take up the Arcane Trickster archetype. Choose Charisma instead if you plan to emphasize deception and social interaction. Second, choose the [b_charlatan](b_charlatan.md) background.
...
You don't need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn't [incapacitated](_conditions.md#incapacitated), and you don't have disadvantage on the attack roll.
...
Starting at 2nd level, your quick thinking and agility allow you to move and act quickly. You can take a bonus action on each of your turns in combat. This action can be used only to take the [Dash](_actions.md#Dash), [Disengage](_actions.md#Disengage), or [Hide](_actions.md#Hide) action.
...
*3rd-level rogue [optional class features](_optional-class-features-tce.md)*
...
Starting at 14th level, if you are able to hear, you are aware of the location of any hidden or [invisible](_conditions.md#invisible) creature within 10 feet of you.
...
Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren't [incapacitated](_conditions.md#incapacitated).
