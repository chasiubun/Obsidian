...
Starting at 3rd level, you can use the bonus action granted by your Cunning Action to make a Dexterity ([Sleight of Hand](_skills.md#Sleight%20of%20Hand)) check, use your [thieves' tools](compendium/items/thieves-tools.md) to disarm a trap or open a lock, or take the [Use an Object](_actions.md#Use%20an%20Object) action.
