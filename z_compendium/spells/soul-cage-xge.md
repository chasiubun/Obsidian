...
A creature that can see the sensor (such as one using [see invisibility](see-invisibility.md) or [truesight](_senses.md#truesight)) sees a translucent image of the tormented humanoid whose soul you caged.
