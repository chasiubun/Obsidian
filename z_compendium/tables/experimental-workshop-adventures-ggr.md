...
| 6 | Capture or kill an elemental or an Izzet weird (a [blistercoil weird](b_blistercoil-weird-ggr.md) or [galvanice weird](b_galvanice-weird-ggr.md)) that is running amok in the workshop, and make sure it doesn't escape out into the city. |
