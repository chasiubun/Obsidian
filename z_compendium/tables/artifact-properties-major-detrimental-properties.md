...
| 26-30 | The artifact imprisons a [death slaad](b_death-slaad.md) (see the Monster Manual). Each time you use one of the artifact's properties as an action, the slaad has a 10% chance chance of escaping, whereupon it appears within 15 feet of you and attacks you. |
...
| 81-85 | Each time you become attuned to the artifact, you age `3d10` years. You must succeed on a DC 10 Constitution saving throw or die from the shock. If you die, you are instantly transformed into a [b_wight](b_wight.md) (see the Monster Manual) under the DM's control that is sworn to protect the artifact. |
...
| 96-00 | When you become attuned to the artifact, there is a 10% chance chance that you attract the attention of a god that sends an avatar to wrest the artifact from you. The avatar has the same alignment as its creator and the statistics of an [b_empyrean](b_empyrean.md) (see the Monster Manual). Once it obtains the artifact, the avatar vanishes. |
^major-detrimental-properties