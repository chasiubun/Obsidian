...
If you are holding the axe, you can use your action to cast the [conjure elemental](conjure-elemental.md) spell from it, summoning an [earth elemental](b_earth-elemental.md). You can't use this property again until the next dawn.
