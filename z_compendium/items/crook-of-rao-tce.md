...
| 26-45 | `2d4` [imps](b_imp.md) and `2d4` [quasits](b_quasit.md) appear. |
| 46-60 | `1d8` [succubi](b_succubus.md)/[incubi](b_incubus.md) appear. |
| 61-70 | `1d10` [barbed devils](b_barbed-devil.md) and `1d10` [vrocks](b_vrock.md) appear. |
| 71-80 | 1 [b_arcanaloth](b_arcanaloth.md), 1 [night hag](2.%20GM%20Tools/5eTools%20Compendium%20&%20Rules/z_compendium/bestiary/fiend/b_night-hag.md), and 1 [b_rakshasa](b_rakshasa.md) appear. |
| 81-85 | 1 [ice devil](b_ice-devil.md) and 1 [b_marilith](b_marilith.md) appear. |
| 86-90 | 1 [b_balor](b_balor.md) and 1 [pit fiend](b_pit-fiend.md) appear. At the DM's discretion, a portal opens into the presence of an archdevil or demon lord instead, then closes after 5 minutes. |
