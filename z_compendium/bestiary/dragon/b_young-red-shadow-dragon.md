...
The dragon's proficiency bonus is doubled for its Dexterity ([Stealth](_skills.md#Stealth)) checks.
...
While in dim light or darkness, the dragon can take the [Hide](_actions.md#Hide) action as a bonus action.

### Sunlight Sensitivity

While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([Perception](_skills.md#Perception)) checks that rely on sight.
