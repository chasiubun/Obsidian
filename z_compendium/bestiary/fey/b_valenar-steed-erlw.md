...
| 2 | Burst of Speed (Recharge 6). The animal can take the [Dash](_actions.md#Dash) action as a bonus action. |
| 3 | Camouflage. The animal has advantage on Dexterity ([Stealth](_skills.md#Stealth)) checks it makes while outdoors. |
| 4 | Lie Detector. The animal knows when a creature within 15 feet of it tells a lie. |
| 5 | Fey Ancestry. The animal has advantage on saving throws against being [charmed](_conditions.md#charmed) or [frightened](_conditions.md#frightened), and magic can't put it to sleep. |
...
| 7 | Quickness (Recharge 6). The animal can take the [Dodge](_actions.md#Dodge) action as a bonus action. |
