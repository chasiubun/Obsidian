...
You know the [minor illusion](minor-illusion.md) cantrip. Starting at 3rd level, you can cast the [invisibility](invisibility.md) spell once with this trait, and you regain the ability to cast it when you finish a long rest. Charisma is your spellcasting ability for these spells.
...
| Spell Level | Spells |
|-------------|--------|
| 1st | [disguise self](disguise-self.md), [silent image](silent-image.md) |
| 2nd | [darkness](darkness.md), [pass without trace](pass-without-trace.md) |
| 3rd | [clairvoyance](clairvoyance.md), [major image](major-image.md) |
| 4th | [greater invisibility](greater-invisibility.md), [hallucinatory terrain](hallucinatory-terrain.md) |
| 5th | [mislead](mislead.md) |
^mark-of-shadow-spells