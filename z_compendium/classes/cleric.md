...
- A [shield](z_compendium/items/shield.md) and a [holy symbol](holy-symbol.md)  
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [b_acolyte](z_compendium/backgrounds/b_acolyte.md) background.
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly move to a space within 30 feet of you. It also can't take reactions. For its action, it can use only the [Dash](_actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can use the [Dodge](_actions.md#Dodge) action.

### Channel Divinity: Harness Divine Power (Level 2)
_Source: Tasha's Cauldron of Everything p. 30_

*2nd-level cleric [optional class features](_optional-class-features-tce.md)*
...
*4th-level cleric [optional class features](_optional-class-features-tce.md)*
