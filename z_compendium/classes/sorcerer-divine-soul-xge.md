...
Starting at 6th level, the divine energy coursing through you can empower healing spells. Whenever you or an ally within 5 feet of you rolls dice to determine the number of hit points a spell restores, you can spend 1 sorcery point to reroll any number of those dice once, provided you aren't [incapacitated](_conditions.md#incapacitated). You can use this feature only once per turn.

### Otherworldly Wings (Level 14)

Starting at 14th level, you can use a bonus action to manifest a pair of spectral wings from your back. While the wings are present, you have a flying speed of 30 feet. The wings last until you're [incapacitated](_conditions.md#incapacitated), you die, or you dismiss them as a bonus action.
