...
You can make a barbarian quickly by following these suggestions. First, put your highest ability score in Strength, followed by Constitution. Second, choose the [b_outlander](b_outlander.md) background.
...
Your rage lasts for 1 minute. It ends early if you are knocked [unconscious](_conditions.md#unconscious) or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.
...
At 2nd level, you gain an uncanny sense of when things nearby aren't as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can't be [blinded](_conditions.md#blinded), [deafened](_conditions.md#deafened), or [incapacitated](_conditions.md#incapacitated).
...
*3rd-level barbarian [optional class features](_optional-class-features-tce.md)*
...
Additionally, if you are surprised at the beginning of combat and aren't [incapacitated](_conditions.md#incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.

### Instinctive Pounce (Level 7)
_Source: Tasha's Cauldron of Everything p. 24_

*7th-level barbarian [optional class features](_optional-class-features-tce.md)*
...
Beginning at 15th level, your rage is so fierce that it ends early only if you fall [unconscious](_conditions.md#unconscious) or if you choose to end it.
