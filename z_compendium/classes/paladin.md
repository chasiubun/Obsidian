...
You can make a paladin quickly by following these suggestions. First, Strength should be your highest ability score, followed by Charisma. Second, choose the [b_noble](z_compendium/backgrounds/b_noble.md) background.
...
*3rd-level paladin [optional class features](_optional-class-features-tce.md)*
...
*4th-level paladin [optional class features](_optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a [fighting style](list-fighting-style-paladin.md) you know with another fighting style available to paladins. This replacement represents a shift of focus in your martial practice.
...
Starting at 10th level, you and friendly creatures within 10 feet of you can't be [frightened](_conditions.md#frightened) while you are conscious.
