...
columns:
  ...
  Ancestry:
    ...
    options:
      ...
      - { label: "Half-Eld", value: "Half-Eld", color: "hsl(24, 95%, 90%)"}
      - { label: "Half-Elf", value: "Half-Elf", color: "hsl(212, 95%, 90%)"}
      - { label: "Custom-Lineage", value: "Custom-Lineage", color: "hsl(202, 95%, 90%)"}
      - { label: "Goliath", value: "Goliath", color: "hsl(154, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
...
config:
  ...
  current_row_template: z_Templates/TTRPG Vault - Templates 281023/z_Templates/1. DM Templates/1. Story World Templates/People/Template - Player.md
  pagination_size: 10
